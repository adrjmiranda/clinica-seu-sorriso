	...
	return (
		...
		>
			<div className="horizontal-wrapper grid gap-8 md:grid-cols-2">
				<div className="bg-tutti/80 relative h-92 rounded-sm shadow-lg md:h-auto">
					<img
						src={AboutImg}
						alt="Sobre Nossa Clínica"
						className="relative top-4 -right-4 h-9/10 w-9/10 translate-0 rounded-sm object-cover object-center shadow-lg sm:absolute sm:top-1/2 sm:-right-48 sm:w-full sm:-translate-1/2 md:-right-52 lg:-right-72"
					/>
				</div>
